...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if Devices[1].sValue == "0":  # Thermostat is off
           ...
           Domoticz.Log("cooling off - Hardware Temp : {}ºC , fan is {}".format(self.intemp, str(Devices[3].sValue)))
            ...
            Domoticz.Log("cooling forced - Hardware Temp : {}ºC , fan is {}".format(self.intemp, str(Devices[3].sValue)))
            ...
            if self.intemp > self.setpoint :
                ...
                if self.intemp < self.setpoint - 10 :
                    if not Devices[3].nValue == 0:
                        ...
                        os.system(cmd)
                        Domoticz.Log("switching cooling off...")
            Domoticz.Log("cooling Auto - Hardware Temp : {}ºC - Setpoint : {}ºC - Fan is {} ".format(self.intemp, self.setpoint, str(Devices[3].sValue)))
