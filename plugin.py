...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if Devices[1].sValue == "0":  # Thermostat is off
           Domoticz.Log("cooling off - Hardware Temp : {}ºC ".format(self.intemp))
           if not Devices[3].nValue == 0:
            ...
            Domoticz.Log("cooling forced- Hardware Temp : {}ºC ".format(self.intemp))
            ...
            Domoticz.Log("cooling Auto - Hardware Temp : {}ºC - Setpoint : {}ºC".format(self.intemp, self.setpoint))
